...
public class PinotKeyValueTransformation<R extends ConnectRecord<R>> extends BaseKeyValueTransformation<R> {
  PinotKeyValueTransformationConfig config;

  protected PinotKeyValueTransformation(boolean isKey) {
    super(isKey);
  }

  @Override
  public ConfigDef config() {
    return PinotKeyValueTransformationConfig.config();
  }
  ...
  public void configure(Map<String, ?> map) {
    this.config = new PinotKeyValueTransformationConfig(map);
  }
   ...
   * @param <R>
   */
  public static class Key<R extends ConnectRecord<R>> extends PinotKeyValueTransformation<R> {
    public Key() {
      super(true);
    }
  }
   ...
   * @param <R>
   */
  public static class Value<R extends ConnectRecord<R>> extends PinotKeyValueTransformation<R> {
    public Value() {
      super(false);
    }
  }
